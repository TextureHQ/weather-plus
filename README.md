...
- 'tomorrow' - Tomorrow.io
  ...
  - Global coverage with real-time conditions; request format is latitude/longitude.
...
The Tomorrow adapter maps the realtime API to our shared schema, normalizing weather codes to `StandardWeatherCondition` and exposing temperature, humidity, dew point, and cloud cover values.
